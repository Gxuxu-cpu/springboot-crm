...
<form action="../basd/add" id="basd">
<table class="query_form_table">
	<tr>
		<th>编号</th>
		<td><input readonly value="系统自动生成"/></td>
		<th>类别</th>
		<td><input id="inputType" name="dictType" list="types" onkeydown="selectTypes()" onfocus="selectTypes()"/>
			<datalist id="types">				
			</datalist>
	...
	<tr>
		<th>是否可编辑</th>
		<td><input type="checkbox" checked value="1" name="dictIsEditable"/></td>
		<th>&nbsp;</th>
		<td>&nbsp;</td>
	</tr>
</table>
