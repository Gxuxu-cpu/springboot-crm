...
<body>
	...
	<form action="../service/arch" id="service">
		<table class="query_form_table" height="53">
			...
			<tr>
				...
				<td><select name="svrStatus">
						<option value="">全部</option>
						<c:forEach items="${Statusl}" var="type">
							<option ${pageInfo.entity.svrStatus==type.dictItem?'selected':''}
								value="${type.dictItem}">${type.dictItem}</option>
						</c:forEach>
				</select></td>
			</tr>
	...
	<table class="data_list_table">
		...
		<tr>
			...
			<td class="list_data_text">${service.svrStatus}</td>
			<td class="list_data_op"><img onclick="to('../service/toarch?svrId=${service.svrId}');"
				title="查看" src="../../images/bt_detail.gif" class="op_button" /></td>
		</tr>
		</c:forEach>
		<tr>
			<th colspan="8" class="pager">
				<form action="../service/arch" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/arch?pageNum=1&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/arch?pageNum=${pageInfo.pageNum-1}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/arch?pageNum=${pageInfo.pageNum+1}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/arch?pageNum=${pageInfo.totalPage}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
