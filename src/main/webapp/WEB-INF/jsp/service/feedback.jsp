	...
	<table class="data_list_table">
		...
		<tr>
			<th colspan="7" class="pager">
				<form action="../service/feedback" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/feedback?pageNum=1&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/feedback?pageNum=${pageInfo.pageNum-1}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/feedback?pageNum=${pageInfo.pageNum+1}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../service/feedback?pageNum=${pageInfo.totalPage}&svrCustName=${pageInfo.entity.svrCustName}&svrTitle=${pageInfo.entity.svrTitle}&svrType=${pageInfo.entity.svrType}&ok=${pageInfo.entity.svrCreateDate}&svrStatus=${pageInfo.entity.svrStatus}&pageSize=${pageInfo.pageSize}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
